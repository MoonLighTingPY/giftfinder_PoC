...
INSERT INTO gifts (name, name_en, description, price_range, budget_min, budget_max, image_url) VALUES
('Бездротові навушники', 'Wireless Headphones', 'Високоякісні шумопоглинаючі бездротові навушники', '$100-$300', 100.00, 300.00, NULL),
('Електронна книга', 'E-Reader', 'Пристрій для читання з екраном, що нагадує папір', '$80-$250', 80.00, 250.00, NULL),
('Розумний годинник', 'Smart Watch', 'Смарт-годинник для фітнесу та здоров\'я', '$150-$400', 150.00, 400.00, NULL),
('Ігрова консоль', 'Gaming Console', 'Сучасна ігрова консоль з контролерами', '$300-$600', 300.00, 600.00, NULL),
('Набір кухонних ножів', 'Kitchen Knife Set', 'Професійний набір кухонних ножів', '$100-$300', 100.00, 300.00, NULL),
('Килимок для йоги', 'Yoga Mat', 'Екологічний нековзкий килимок для йоги', '$20-$50', 20.00, 50.00, NULL),
('Цифрова камера', 'Digital Camera', 'Компактна бездзеркальна цифрова камера', '$400-$1000', 400.00, 1000.00, NULL),
('Набір для художника', 'Art Supply Set', 'Професійний набір для малювання в дерев\'яному кейсі', '$50-$150', 50.00, 150.00, NULL),
('Туристичний рюкзак', 'Travel Backpack', 'Ергономічний легкий рюкзак для подорожей', '$50-$150', 50.00, 150.00, NULL),
('Набір для програмування роботів', 'Arduino Programming Kit', 'Освітній набір для вивчення програмування', '$80-$200', 80.00, 200.00, NULL),
('Механічна клавіатура', 'Mechanical Keyboard', 'RGB механічна клавіатура для ігор та програмування', '$80-$200', 80.00, 200.00, NULL),
('Набір садових інструментів', 'Garden Tool Set', 'Повний набір садових інструментів та аксесуарів', '$30-$100', 30.00, 100.00, NULL),
('Портативна Bluetooth колонка', 'Portable Bluetooth Speaker', 'Водонепроникна портативна Bluetooth колонка', '$50-$150', 50.00, 150.00, NULL),
('Стильний годинник', 'Stylish Watch', 'Наручний годинник класичного дизайну для будь-якого випадку', '$100-$500', 100.00, 500.00, NULL),
('Колекція кулінарних книг', 'Cookbook Collection', 'Набір популярних кулінарних книг', '$40-$120', 40.00, 120.00, NULL),
('Конструктор LEGO', 'LEGO Set', 'Набір для розвитку креативності та моторики', '$30-$100', 30.00, 100.00, NULL),
('Інтерактивна іграшка', 'Interactive Toy', 'Розумна іграшка з освітніми функціями', '$40-$80', 40.00, 80.00, NULL),
('Набір для творчості', 'Creativity Kit', 'Комплект для малювання та рукоділля', '$20-$60', 20.00, 60.00, NULL),
('Дитячий планшет', 'Children\'s Tablet', 'Спеціальний планшет для навчання дітей', '$80-$150', 80.00, 150.00, NULL),
('Розвиваюча настільна гра', 'Educational Board Game', 'Гра для розвитку логіки та мислення', '$15-$40', 15.00, 40.00, NULL),
('Бездротові навушники для гейминга', 'Gaming Headphones', 'Ігрові навушники з мікрофоном та RGB підсвіткою', '$60-$150', 60.00, 150.00, NULL),
('Рюкзак для підлітків', 'Teen Backpack', 'Стильний та місткий рюкзак для школи', '$30-$80', 30.00, 80.00, NULL),
('Смарт-годинник для підлітків', 'Teen Smartwatch', 'Водостійкий годинник з трекером активності', '$50-$120', 50.00, 120.00, NULL),
('Набір для наукових експериментів', 'Science Experiment Kit', 'Комплект для проведення простих наукових дослідів', '$40-$90', 40.00, 90.00, NULL),
('Портативна ігрова консоль', 'Portable Gaming Console', 'Компактна консоль для ігор у дорозі', '$150-$300', 150.00, 300.00, NULL),
('Кофемашина', 'Coffee Machine', 'Автоматична кавомашина для дому або офісу', '$150-$500', 150.00, 500.00, NULL),
('Комплект для домашнього кінотеатру', 'Home Theater System', 'Система з якісним звуком та зображенням', '$300-$800', 300.00, 800.00, NULL),
('Набір для виготовлення крафтового пива', 'Craft Beer Kit', 'Комплект для домашнього пивоваріння', '$80-$200', 80.00, 200.00, NULL),
('Електричний самокат', 'Electric Scooter', 'Компактний транспортний засіб для міста', '$300-$700', 300.00, 700.00, NULL),
('Набір для йоги преміум-класу', 'Premium Yoga Kit', 'Високоякісне спорядження для практики йоги', '$100-$250', 100.00, 250.00, NULL),
('Шкіряний портфель', 'Leather Briefcase', 'Елегантний портфель для ділових зустрічей', '$100-$300', 100.00, 300.00, NULL),
('Професійна кавоварка', 'Professional Coffee Maker', 'Кавоварка для справжніх цінителів кави', '$200-$500', 200.00, 500.00, NULL),
('Графічний планшет', 'Graphics Tablet', 'Пристрій для дизайнерів та ілюстраторів', '$150-$800', 150.00, 800.00, NULL),
('Комплект для запису подкастів', 'Podcast Recording Kit', 'Набір для створення якісних аудіозаписів', '$120-$400', 120.00, 400.00, NULL),
('Розумний годинник преміум-класу', 'Premium Smartwatch', 'Багатофункціональний годинник з преміальних матеріалів', '$200-$800', 200.00, 800.00, NULL),
('Набір для догляду за бородою', 'Beard Care Kit', 'Комплект для чоловіків із засобами по догляду за бородою', '$40-$100', 40.00, 100.00, NULL),
('Жіночий подарунковий набір косметики', 'Women\'s Cosmetics Gift Set', 'Набір люксової косметики для жінок', '$70-$200', 70.00, 200.00, NULL),
('Набір інструментів преміум-класу', 'Premium Tool Set', 'Професійні інструменти для домашнього майстра', '$100-$300', 100.00, 300.00, NULL),
('Шовкова піжама', 'Silk Pajamas', 'Розкішна піжама з натурального шовку', '$80-$200', 80.00, 200.00, NULL),
('Спортивний годинник із GPS', 'Sports Watch with GPS', 'Годинник для тренувань з функцією відстеження маршруту', '$150-$500', 150.00, 500.00, NULL),
('Стетоскоп преміум-класу', 'Premium Stethoscope', 'Високоякісний медичний інструмент для лікарів', '$150-$300', 150.00, 300.00, NULL),
('Набір для програмування Arduino', 'Arduino Programming Kit', 'Комплект для створення електронних проєктів', '$60-$150', 60.00, 150.00, NULL),
('Професійний мікроскоп', 'Professional Microscope', 'Точний інструмент для наукових досліджень', '$200-$800', 200.00, 800.00, NULL),
('Набір архітектурних олівців', 'Architectural Pencil Set', 'Професійні креслярські інструменти', '$40-$120', 40.00, 120.00, NULL),
('Портативна студія звукозапису', 'Portable Recording Studio', 'Комплект для створення музики в будь-якому місці', '$200-$600', 200.00, 600.00, NULL);
